...
save "data_study_2_long.dta", replace
...
esttab T1 T2 T3 T4 using tobit.tex, label se star(* 0.10 ** 0.05 *** 0.01) replace
...
save "data_study_2_aux", replace

use "data_study_1.dta", clear

keep if complete == 1

append using "data_study_2_aux.dta", generate(file)
